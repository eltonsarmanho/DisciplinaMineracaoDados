...
\begin{tikzpicture}
% ════════════════════════════════════════════════════════════════
% Cada subplot: 5.2cm × 3.8cm  |  Colunas: xshift 0 e 6.8cm
% Linhas: yshift 4.8cm (topo) e 0cm (base)   Gap vertical: 1cm
% ════════════════════════════════════════════════════════════════
...
\end{tikzpicture}
\captionof{figure}{Quatro gráficos diagnósticos padrão para regressão. Superior esq.: resíduos sem padrão indicam bom ajuste. Superior dir.: normalidade dos resíduos pelo Q-Q plot. Inferior esq.: homocedasticidade (variância constante). Inferior dir.: Cook's Distance identifica pontos influentes.}
\end{center}
