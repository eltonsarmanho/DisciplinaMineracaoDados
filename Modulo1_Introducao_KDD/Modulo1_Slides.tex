...
\begin{frame}{Estado da Arte: Explainable AI (XAI)}
    ...
    \vspace{0.2cm}
    \begin{itemize}
        \item \textbf{SHAP} (Lundberg \& Lee, 2017): baseado na teoria dos jogos cooperativos. Atribui contribuições individuais a cada \textit{feature} para uma predição. 
...
\begin{frame}{Ética e Responsabilidade em Mineração de Dados}
    ...
    \begin{block}{\faLock\ Privacidade de Dados}
        Dados pessoais sensíveis exigem \textbf{anonimização eficaz}, consentimento informado e minimização do uso que são princípios centrais da LGPD.
    \end{block}
\end{frame}
